...
public class TestBasicMapOps extends TestBase<String> {
    ...
    public void testMapOps() {
        Map<H3CellId<String>, Integer> sctm = new SpacialConcurrentTrieMap<>();
    ...
    public void testConcurrentMapOps() {
        final ConcurrentMap<H3CellId<String>, Integer> sctm = new SpacialConcurrentTrieMap<>();
        for (int i = 0; i < 10; i++) {
    ...
    public void testBasicAddOpsLongScenario() {
        ...
        var t = new SpacialConcurrentTrieMap<String, String>();
