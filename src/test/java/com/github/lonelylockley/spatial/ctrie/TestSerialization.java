...
public class TestSerialization extends TestBase<String> {
    ...
    private final SpatialConcurrentTrieMap<String, Integer> base = new SpatialConcurrentTrieMap<>();
    private SpatialConcurrentTrieMap<String, Integer> deserialized = null;
    ...
    public void setUp() throws IOException, ClassNotFoundException {
        ...
        final var actual = (SpatialConcurrentTrieMap<String, Integer>) ois.readObject();
