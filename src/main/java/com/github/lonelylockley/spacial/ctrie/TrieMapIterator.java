...
import com.github.lonelylockley.spacial.ctrie.nodes.BranchNode;
import com.github.lonelylockley.spacial.ctrie.nodes.CollisionAwareNode;
import com.github.lonelylockley.spacial.ctrie.nodes.LeafNode;
import com.github.lonelylockley.spacial.ctrie.nodes.NodeWrapper;
import com.github.lonelylockley.spacial.ctrie.nodes.TerminalNode;
import com.github.lonelylockley.spacial.ctrie.nodes.TombstoneNode;
...
public class TrieMapIterator <T, V> implements Iterator<Map.Entry<H3CellId<T>, V>> {
    private int level;
    protected SpacialConcurrentTrieMap<T, V> ct;
    ...
    TrieMapIterator(int level, final SpacialConcurrentTrieMap<T, V> ct, boolean mustInit) {
        this.level = level;
        this.ct = ct;
    ...
    TrieMapIterator(int level, SpacialConcurrentTrieMap<T, V> ct) {
        this(level, ct, true);
    }
    ...
    protected TrieMapIterator<T, V> newIterator(int lev, SpacialConcurrentTrieMap<T, V> ct, boolean mustInit) {
